...
if(conn != None):
  ...
  conn.execute("INSERT INTO articles VALUES(null,'The best article ever','This is the best article ever written','A great article!','David Feinzimer','4/7/19','4/7/19')")
  conn.execute("INSERT INTO articles VALUES(null,'My great article'     ,'There once was a lightbulb'           ,'Yup, it is true' ,'David Feinzimer','4/2/19','4/6/19')")
  conn.commit()
  conn.close()
...
if(conn != None):
  ...
  conn.execute("INSERT INTO comments VALUES(null,1,'What a great article','4/7/19')")
  conn.commit()
  conn.close()
...
if(conn != None):
  ...
  conn.execute("INSERT INTO users VALUES(null,'test@email.com',54,'dfeinzimer')")
  conn.commit()
  conn.close()
